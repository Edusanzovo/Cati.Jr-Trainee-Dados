...
| Tratamento dos Outliers | R² | MSE | RMSE |
|-------------------------|---:|------------:|---------:|
| Sem remoção | **0.939** | 404.397.464 | 20.110 |
| Remoção > 700000 | **0.932** | 358.910.102 | 18.945 |
| Remoção > 500000 | **0.903** | 468.213.205 | 21.638 |
| Remoção de todos os outliers | **0.924** | 269.250.694 | 16.409 |
